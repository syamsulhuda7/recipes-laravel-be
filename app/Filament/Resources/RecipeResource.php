...
use App\Filament\Resources\RecipeResource\RelationManagers\RecipeTutorialsRelationManager;
...
class RecipeResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Forms\Components\Repeater::make('recipePhotos')
                    ->relationship('recipePhotos')
                    ->schema([
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\ImageColumn::make('recipeAuthor.photo')
                    ->circular(),
    ...
    {
        return [
            RecipeTutorialsRelationManager::class,
        ];
    }
